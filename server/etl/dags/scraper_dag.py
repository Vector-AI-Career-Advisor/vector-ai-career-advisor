...
def task_scrape(**context):
    from server.etl.core import run_scrape
...
def task_extract(**context):
    from server.etl.core import run_extract
...
def task_load_postgres(**context):
    from server.etl.core import run_load_postgres
...
def task_load_chroma(**context):
    from server.etl.core import run_load_chroma
