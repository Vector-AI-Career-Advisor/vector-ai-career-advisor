...
def test_mint_and_verify_round_trip():
    from server.mcp_server.auth import mint_agent_token, verify_agent_token
...
def test_verify_rejects_bad_signature():
    ...
    from server.mcp_server.auth import ALGORITHM, verify_agent_token
...
def test_verify_rejects_expired_token():
    ...
    from server.mcp_server.auth import ALGORITHM, _secret, verify_agent_token
